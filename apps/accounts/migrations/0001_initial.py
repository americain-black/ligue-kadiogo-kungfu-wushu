...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nom_role', models.CharField(choices=[('SUPER_ADMIN', 'Super Administrateur'), ('GEST_LIGUE', 'Gestionnaire Ligue'), ('GEST_CLUB', 'Gestionnaire Club'), ('GEST_FINANCIER', 'Gestionnaire Financier'), ('JURY', 'Jury')], max_length=50, unique=True)),
                ('description', models.TextField(blank=True)),
            ],
            options={
                'verbose_name': 'Rôle',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('token_reinitialisation', models.UUIDField(blank=True, default=uuid.uuid4, null=True)),
        ...
        migrations.AddField(
            ...
            name='roles',
            field=models.ManyToManyField(blank=True, related_name='utilisateurs', through='accounts.UtilisateurRole', to='accounts.role'),
        ),
    ]
