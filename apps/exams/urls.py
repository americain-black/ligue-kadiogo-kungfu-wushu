...
urlpatterns = [
    ...
    path('<int:pk>/gestion/',                 views.gestion_session,       name='gestion_session'),
    path('<int:pk>/dossiers/',                          views.traiter_dossiers,      name='traiter_dossiers'),
    path('<int:session_pk>/dossiers/<int:club_pk>/',   views.traiter_dossier_club,  name='traiter_dossier_club'),
    ...
    path('<int:pk>/cloturer-session/',        views.cloturer_session,      name='cloturer_session'),
    path('<int:pk>/publier-resultats/',       views.publier_resultats,     name='publier_resultats'),
    ...
    path('<int:pk>/jury/',                                       views.gestion_jury,               name='gestion_jury'),
    path('<int:session_pk>/jury/liste/',                         views.liste_jury_affecte,         name='liste_jury_affecte'),
    path('<int:session_pk>/jury/imprimer/',                      views.imprimer_affectations_jury, name='imprimer_affectations_jury'),
    path('<int:session_pk>/jury/<int:affectation_pk>/config/',   views.configurer_jury,            name='configurer_jury'),
    path('inscriptions/<int:pk>/exclure/',                       views.exclure_inscription,    name='exclure_inscription'),
    path('inscriptions/<int:pk>/reintegrer/',                    views.reintegrer_inscription, name='reintegrer_inscription'),
